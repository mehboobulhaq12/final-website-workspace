...
if (typeof document !== "undefined" && !document.getElementById("effect3-ai-prompt-box-styles")) {
  const styleSheet = document.createElement("style");
  styleSheet.id = "effect3-ai-prompt-box-styles";
...
const PromptInputAction: React.FC<PromptInputActionProps> = ({
  ...
  return (
    <Tooltip {...props}>
      {disabled ? children : <TooltipTrigger asChild>{children}</TooltipTrigger>}
